...
<html>
    ...
    <body>
        ...
        <div id="resultCard" class="card">
            ...
            <span style="font-style: italic; display: block; margin-top: 1.5rem; font-size: 0.8rem; color: #666; text-align: center; width: 100%;">20260824.1103 ©2025-26 ego/DEV/null</span>
        </div>
